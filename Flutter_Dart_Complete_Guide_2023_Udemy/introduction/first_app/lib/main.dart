...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      // 'Material' stands for Material Design which is Google's flexible
      // design system - a set of suggestions, rules & guidelines that help
      // us build beautiful user interfaces - flutter embraces Material Design
